...
// เนื่องจากไฟล์นี้อยู่ใน root directory ไม่ต้องแก้ base path
$base_path = './';
...
?>
    ...
    <header class="unified-header">
        <div class="unified-header-content">
            <a href="index.php" class="back-button">← กลับสู่เมนูหลัก</a>
            <img src="https://media.jobthai.com/v1/images/logo-pic-map/309288_pic_20220902165518.jpeg?type=webp&width=3840&quality=50&blur=1" alt="Archem Logo" class="header-logo">
        </div>
    </header>
    ...
    <!-- Hidden Content Storage - EDITED with new div wrappers -->
